...
class AirConditionerAccessory extends BaseAccessory {
    ...
    constructor(...props) {
        ...
        if (!this.device.context.noRotationSpeed) {
            ...
            if (this.device.context._rotationSteps && this.device.context._rotationStops) {
                
                this._rotationSteps = this.device.context._rotationSteps;
                this._rotationStops = this.device.context._rotationStops;
    ...
    setRotationSpeed(value, callback) {
        ...
        this.setMultiState({'5': this.convertRotationSpeedFromHomeKitToTuya(value)}, callback);
    }

    convertRotationSpeedFromTuyaToHomeKit(value) {
        return this._rotationStops[value];
    }
